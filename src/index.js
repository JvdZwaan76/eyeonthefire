...
async function handleRequest(request) {
  ...
  console.log('NASA_FIRMS_API_KEY:', NASA_FIRMS_API_KEY);
  ...
  if (url.pathname === '/' || url.pathname === '/index.html') {
    ...
    // Fetch index.html from your hosting (adjust URL if needed)
  ...
  if (url.pathname.startsWith('/nasa/firms')) {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error('Failed to fetch data from NASA FIRMS');
      }
